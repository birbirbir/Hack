...
\paragraph{Hint} Check your PHP file type by \texttt{file filename.php} (see \ref{subsec:file}).
...
\subsection{OAuth bypassing}
\subsubsection{OAuth}
OAuth is open standard for access delegation.
It is not authorisation protocol.
OAuth only delegates authorisation processes and provides secure access to server resources on behalf of a resource owner.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{wpscanner}
Automated wordpress-based sites scanner.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
